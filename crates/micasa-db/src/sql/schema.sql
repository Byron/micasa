...
CREATE UNIQUE INDEX IF NOT EXISTS idx_project_types_name ON project_types (name);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_maintenance_categories_name ON maintenance_categories (name);
...
CREATE INDEX IF NOT EXISTS idx_appliances_warranty_expiry ON appliances (warranty_expiry);
CREATE INDEX IF NOT EXISTS idx_appliances_deleted_at ON appliances (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_maintenance_items_category_id ON maintenance_items (category_id);
CREATE INDEX IF NOT EXISTS idx_maintenance_items_appliance_id ON maintenance_items (appliance_id);
CREATE INDEX IF NOT EXISTS idx_maintenance_items_deleted_at ON maintenance_items (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_incidents_appliance_id ON incidents (appliance_id);
...
CREATE INDEX IF NOT EXISTS idx_service_log_entries_maintenance_item_id ON service_log_entries (maintenance_item_id);
CREATE INDEX IF NOT EXISTS idx_service_log_entries_vendor_id ON service_log_entries (vendor_id);
CREATE INDEX IF NOT EXISTS idx_service_log_entries_deleted_at ON service_log_entries (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_doc_entity ON documents (entity_kind, entity_id);
...
CREATE INDEX IF NOT EXISTS idx_deletion_records_entity ON deletion_records (entity);
CREATE INDEX IF NOT EXISTS idx_deletion_records_target_id ON deletion_records (target_id);
CREATE INDEX IF NOT EXISTS idx_deletion_records_deleted_at ON deletion_records (deleted_at);
CREATE INDEX IF NOT EXISTS idx_entity_restored ON deletion_records (entity, restored_at);
